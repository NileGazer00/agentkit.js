...
| TypeScript inference | Full | Partial |
| Streaming | Native | Callbacks |
| Abstractions | None | Many |
...
**Summary memory** compresses longer histories automatically:
...
Try it live: [agentkit.js demo](https://nilegazer00.github.io/agentkit.js/)
...
- 📧 Email: [jusspound@gmail.com](mailto:jusspound@gmail.com)
- 🌐 Portfolio: [nilegazer00.github.io](https://nilegazer00.github.io/)
- 🐙 GitHub: [NileGazer00](https://github.com/NileGazer00)

## 🤝 Contributing

Contributions are welcome. Please open an issue first for significant changes, then submit a pull request.
